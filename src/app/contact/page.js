              ...
              <div className="space-y-14">
                ...
                <div className="flex items-center gap-5 pt-4">
                  {[
                    ...
                    <a key={s.label} href="#" className="w-14 h-14 bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#D32F23] hover:border-[#D32F23] hover:text-white transition-all duration-300">
                ...
                {submitted ? (
                  ...
                  <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <button type="submit" disabled={isSubmitting}
                      className="w-full py-6 bg-[#D32F23] text-white text-lg font-black uppercase tracking-[0.2em] hover:bg-[#B52419] transition-colors duration-300 disabled:opacity-50 flex items-center justify-center gap-3">
                      {isSubmitting ? (
                        <>
