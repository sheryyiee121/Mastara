    ...
    <main ref={heroRef} className="overflow-hidden bg-black">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            {tourSpaces.map((space, index) => (
              <AnimatedSection key={space.title} animation="scaleUp" delay={index * 0.1}>
                <div
                  className="group relative overflow-hidden cursor-pointer h-[520px] sm:h-[560px]"
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-linear-to-t from-black via-black/50 to-transparent opacity-80 group-hover:opacity-95 transition-opacity duration-300" />
                  <div className="absolute inset-x-0 bottom-0 p-6 sm:p-10 lg:p-12 pb-8 sm:pb-12 lg:pb-14">
      ...
      <section className="relative w-full py-48 md:py-56">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-8 sm:px-12 lg:px-24">
          <AnimatedSection animation="fadeUp" className="text-center mb-32 md:mb-40">
            ...
            <div className="mt-12 w-24 h-1 bg-[#D32F23] mx-auto" />
            <p className="mt-12 text-gray-400 text-xl max-w-2xl mx-auto leading-[1.85]">
              Immerse yourself in the warm, inviting atmosphere that makes Mastara truly special
            </p>
          </AnimatedSection>

          <div className="grid grid-cols-12 gap-4 md:gap-6">
            <AnimatedSection animation="scaleUp" delay={0} className="col-span-12 md:col-span-8 relative h-[560px] overflow-hidden group cursor-pointer" onClick={() => setLightboxImage("https://images.pexels.com/photos/67468/pexels-photo-67468.jpeg")}>
            ...
            <AnimatedSection animation="scaleUp" delay={0.1} className="col-span-12 md:col-span-4 relative h-[560px] overflow-hidden group cursor-pointer" onClick={() => setLightboxImage("https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg")}>
            ...
            {[
              ...
              <AnimatedSection key={i} animation="scaleUp" delay={i * 0.08 + 0.1} className="col-span-6 md:col-span-3 relative h-[360px] overflow-hidden group cursor-pointer" onClick={() => setLightboxImage(src)}>
              ...
              <AnimatedSection key={reel.title} animation="fadeUp" delay={index * 0.08}>
                <div className="group relative cursor-pointer">
                  <div className="aspect-[9/16] relative overflow-hidden">
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5 lg:p-6 pb-5 sm:pb-6 lg:pb-8 bg-linear-to-t from-black via-black/80 to-transparent">
      ...
      <section className="w-full bg-black py-48 md:py-56">
        <div className="max-w-[1600px] mx-auto px-8 sm:px-12 lg:px-24">
          <AnimatedSection animation="fadeUp" className="text-center mb-24 md:mb-32">
            ...
            <h2 className="mt-10 text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black text-white leading-none">
              Brand<br />Identity
            </h2>
            <div className="mt-12 w-24 h-1 bg-[#D32F23] mx-auto" />
            <p className="mt-12 text-gray-400 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            {brandImages.map((item, index) => (
              <AnimatedSection key={item.title} animation="scaleUp" delay={index * 0.15}>
                <div 
                  className="group relative overflow-hidden cursor-pointer bg-[#0a0a0a] border border-white/5 hover:border-[#D32F23]/30 transition-all duration-500"
      ...
      <section className="w-full bg-[#080808] py-48 md:py-56">
        <div className="max-w-[1600px] mx-auto px-8 sm:px-12 lg:px-24">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-5 mb-20">
